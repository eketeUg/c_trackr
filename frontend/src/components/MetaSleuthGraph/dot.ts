...
// We map our backend nodes/edges to these interfaces or define them here
...
const genEdge = (
  ...
  return `
        ...
        [
          ...
          label=<<table border="0">
          <tr><td align="center" width="20" bgcolor="transparent" cellpadding="0"><font color="${themeColor}" FACE="Poppins-Regular"><br/>[${serial}] </font></td><td align="center" cellpadding="0"><font color="#d0d6e5"><br/>${description}</font></td></tr>
          </table>>
        ]
      `;
};
